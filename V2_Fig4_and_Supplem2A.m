...
% save('Mean_decoding_accuracy_cmplt.mat','data')
save('Max_decoding_accuracy_cmplt.mat','data')
ccc
...
% ind_sig_total=nan*ones(26,3,10);
% for Dataset=1:3
%     accuracies=nan*ones(35,231,10);
%     if Dataset<3
...
%     end
% end
% save('First_above_chance_time_cmplt.mat','ind_sig_total','data_max');
% ccc
load('First_above_chance_time_cmplt.mat');
...
save('First_above_chance_decoding_accuracy_cmplt.mat','data')
ccc
...
data=data_max*5+30;
save('Max_time_decoding_accuracy_cmplt.mat','data')
...
clear all;
close all;
% load('Max_decoding_accuracy_cmplt.mat','data')
% load('Mean_decoding_accuracy_cmplt.mat','data')
% load('First_above_chance_decoding_accuracy_cmplt.mat')
load('Max_time_decoding_accuracy_cmplt.mat','data')
...
text(53.5,55,['r = ',num2str(r,'%.2f')],'FontSize',20)
text(53.5,53.5,['p = ',num2str(p,'%.2f')],'FontSize',20)
xlim([48 56])
ylim([50 70])
...
text(155,130,['r = ',num2str(r,'%.2f')],'FontSize',20)
text(155,118,['p = ',num2str(p,'%.2f')],'FontSize',20)
xlim([50 200])
ylim([100 250])
end