...
%                 clearvars YY XX
        ...
        save(['Corrected_Dec_DS_',Datasets{Dataset},'_Band_',Bands{band},'_Wind_sliding_Subject_',num2str(Subject),'_CombFeat_seq_PCA_Unz.mat'],'accuracy','Sel_feat');
    end
end
