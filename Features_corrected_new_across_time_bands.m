...
Subjects=[1:2];
bands=[3]; % 1=broad, 2=delta, 3=theta, 4=alpha, 5=beta, 6=gamma
Windows=[1:231];
    ...
    for Subject=Subjects
        ...
        for windoww=Windows
            ...
            %   broad-band whole-time windows: set band=1 and windoww=1
              ...
              for feature=[1:9 11:13 18:20] % features when evaluating freq bands
        ...
        save(['Corrected_Dec_DS_',Datasets{Dataset},'_Band_',Bands{band},'_Wind_sliding_Subject_',num2str(Subject),'.mat'],'accuracy');
    end
end
