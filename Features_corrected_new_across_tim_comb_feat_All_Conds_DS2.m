...
%                     for feature=[2:3] % features when evaluating time windows
                    ...
                    %% Classification
                    clearvars -except selection_method cued Feat_selection Sel_feat Windows Subjects bands lowband highband band windows windoww wind Dataset Fs True_Predicted_labels accuracy Subject signal feature X Y  net
                    ...
                    for combination=1:size(combinations,1)
                        ...
                        [band cued Feat_selection Subject windoww combination]
                    end                    
                    Datasets={'Mine','Vhab','Stfd'};
                    Bands={'Broad','Delta','Theta','Alpha','Betta','Gamma'};
                end
                save(['Corrected_Dec_DS_',Datasets{Dataset},'_Cued_',num2str(cued),'_Band_',Bands{band},'_Wind_slid_Subject_',num2str(Subject),'_CombFeat_',selection_method,'_PCA.mat'],'accuracy','Sel_feat');
            end
        end
    end
end
