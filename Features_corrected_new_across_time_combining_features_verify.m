...
%                 features_chosen(:,:,:,feat)=(feature_chosen);
            ...
            %             mdl = fitglm(features_chosen_tmp(1:31,:)',Y);
            %             Ref_adj_r_squared=mdl.Rsquared.Adjusted;
            %
            %             X=features_chosen_tmp(1:31,:);
            ...
            %                 feature_tmp(:,nans)=[];
            %                 mdl = fitglm([features_chosen_tmp(1:31,:);feature_tmp]',Y);
...
%             X=t;
        ...
        save(['Corrected_Dec_DS_',Datasets{Dataset},'_Band_',Bands{band},'_Wind_sliding_Subject_',num2str(Subject),'_verify.mat'],'accuracy','Sel_feat');
    end
end
