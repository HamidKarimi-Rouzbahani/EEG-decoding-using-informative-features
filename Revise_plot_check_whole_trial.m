...
chosen_features_order=[1:9 11:13 18:20 14:17 27 21:26 32 28:30 34:35 36 37];
...
xtic=[1:1.8:61];
xtic(7:32)=xtic(7:32)+1;
xtic(20:32)=xtic(20:32)+1;
xtic(27:32)=xtic(27:32)+1;
xtic(33:34)=xtic(33:34)+1;
...
% end
% 
% set(gca,'FontSize',24,'DefaultTextFontName','Calibri','XTick',...
...
figure;
        chosen_features_order=[2:9 11:13 18:20 14:17 27 32 28:30 34];
        Features={'Mean','Median','Variance','Skewness','Kurtosis','LZ Cmplx',...
            'Higuchi FD','Katz FD','Hurst Exp','Sample Ent','Apprx Ent',...
            'Autocorr','Hjorth Cmp','Hjorth Mob','P1','N1','P2a','P2b',...
            'Signal Pw','Cros Cor','Wavelet',...
            'Hilb Amp','Hilb Phs','Samples'};
        
Significanc_mat=nan(6,6,24);
for band1=bands
    for band2=bands
        for Subject=1:10
...
f=0;
for feature=length(chosen_features_order):-1:1
% for feature=5
    for band1=bands
        for band2=bands
    ...
    figure;
    f=1;
    subplot_tmp=subplot(1,1,f);
%     subplot_tmp=figure(1);
%     hold(subplot_tmp,'on');
...
%     set(subplot_tmp,'CLim',[0 6],'DataAspectRatio',[1 1 1],'FontSize',12,'FontName','Calibri');
    set(subplot_tmp,'CLim',[0 6],'DataAspectRatio',[1 1 1],'FontSize',60,'FontName','Calibri');
    box off
...
for band=1:length(bands)
    ...
    if band==1
        chosen_features_order=[2:9 11:13 18:20 14:17 27 21:26 32 28:30 34];
        Features={'Mean','Median','Variance','Skewness','Kurtosis','LZ Cmplx',...
            'Higuchi FD','Katz FD','Hurst Exp','Sample Ent','Apprx Ent',...
            'Autocorr','Hjorth Cmp','Hjorth Mob','P1','N1','P2a','P2b',...
            'Signal Pw','Mean Freq','Med Freq','Avg Freq','SEF 95%','Pw MdFrq','Phs MdFrq','Cros Cor','Wavelet',...
    ...
    if band==1
        ...
        set(subplot_tmp,'CLim',[0 6],'DataAspectRatio',[1 1 1],'FontSize',9,'FontName','Calibri');
    end
