...
%             for Feat_sel=32:size(features_chosen_tmp,1)
%                 mdl = fitglm([features_chosen_tmp(1:size(signal,1),:);features_chosen_tmp(Feat_sel,:)]',Y);
%                 Feat_adj_r_squared=mdl.Rsquared.Adjusted;
%                 
%                 if Feat_adj_r_squared>Ref_adj_r_squared
%                     X=vertcat(X,features_chosen_tmp(Feat_sel,:));
...
%             X=X';
                          ...
                          [fs,history] = sequentialfs(fun,features_chosen_tmp',Y','cv',c);
...
%                         Features_selected=numb(1:size(signal,1));
                        ...
                        Sel_feat(windoww,Features_selected)=1;
        ...
        save(['Corrected_Dec_DS_',Datasets{Dataset},'_Band_',Bands{band},'_Wind_sliding_Subject_',num2str(Subject),'_SelFeat.mat'],'accuracy','Sel_feat');
    end
end
