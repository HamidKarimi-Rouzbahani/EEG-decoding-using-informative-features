...
%               for feature=[2:9 11:13 18:27] % features when evaluating time windows
              for feature=[28] % features when evaluating time windows
        ...
        save(['Corrected_Dec_DS_',Datasets{Dataset},'_Band_',Bands{band},'_Wind_sliding_Subject_',num2str(Subject),'_Wave.mat'],'accuracy');
    end
end
