...
%     'Hilb Amp','Hilb Phs','CNN','Orig Mag'};
...
Features={'Baseline','Mean','Median','Variance','Skewness','Kurtosis','LZ Cmplx',...
    ...
    'Signal Pw','Mean Freq','Med Freq','Avg Freq','SEF 95%','Pw MdFrq','Phs MdFrq','Cross Corr','Wavelet',...
    'Hilb Amp','Hilb Phs','Amp Lock','Phs Lock','Orig Mag'};
chosen_features_order=[1:9 11:13 18:20 14:17 27 21:26 32 28:30 36:37 34:35];
...
figure;
gca = axes('Position',[0.055 0.40 0.935 0.1]); %x position, y position, x size and y size
...
set(gca,'FontSize',20,'DefaultTextFontName','Calibri','XTick',...
...
box off;
%% Bar plots
gca = axes('Position',[0.055 0.5 0.935 0.5]);%x position, y position, width and height
...
set(gca,'FontSize',20,'DefaultTextFontName','Calibri','XTick',[xtic]+0.88,'XTickLabel',{''},'YTick',[0.5 0.55 0.6 0.65],'YTickLabel',{'50','55','60','65'});
box off;
ylabel('Decoding Accuracy (%)')
xlim([2.6 63.5])
ylim([0.45 0.68]);
legend([Bars{1},Bars{2},Bars{3},Bars{4},Bars{5},Bars{6}],{'Broad','Delta(\delta)','Theta(\theta)','Alpha(\alpha)',...
    'Beta(\beta)','Gamma(\gamma)'},'location','northwest','EdgeColor',[1 1 1],'FontSize',16);

ccc
%% Cross significance 1
% figure;
% chosen_features_order=[2:9 11:13 18:20 14:17 27 32 28:30 36 37 34];
% Features={'Mean','Median','Variance','Skewness','Kurtosis','LZ Cmplx',...
%     'Higuchi FD','Katz FD','Hurst Exp','Sample Ent','Apprx Ent',...
%     'Autocorr','Hjorth Cmp','Hjorth Mob','P1','N1','P2a','P2b',...
%     'Signal Pw','Cross Corr','Wavelet',...
%     'Hilb Amp','Hilb Phs','Amp Lock','Phs Lock','Orig Mag'};
% 
% Significanc_mat=nan(6,6,26);
% for band1=bands
%     for band2=bands
%         for Subject=1:10
...
%     axis(subplot_tmp,'ij');
%     set(subplot_tmp,'CLim',[0 6],'DataAspectRatio',[1 1 1],'FontSize',30,'FontName','Calibri');
%     
...
for band=length(bands):-1:1
    clearvars Significanc_mat Bayes_mat
    if band==1
        chosen_features_order=[2:9 11:13 18:20 14:17 27 21:26 32 28:30 36 37 34];
        Features={'Mean','Median','Variance','Skewness','Kurtosis','LZ Cmplx',...
            'Higuchi FD','Katz FD','Hurst Exp','Sample Ent','Apprx Ent',...
            'Autocorr','Hjorth Cmp','Hjorth Mob','P1','N1','P2a','P2b',...
            'Signal Pw','Mean Freq','Med Freq','Avg Freq','SEF 95%','Pw MdFrq','Phs MdFrq','Cross Corr','Wavelet',...
...
%     hold(subplot_tmp,'on');
    ...
    axis(subplot_tmp,'ij');
    if band==1
        set(subplot_tmp,'CLim',[0 6],'TickLength', [0 0],'Box','off','DataAspectRatio',[1 1 1],'FontSize',7,'FontName','Calibri');
    else
        set(subplot_tmp,'CLim',[0 6],'TickLength', [0 0],'Box','off','DataAspectRatio',[1 1 1],'FontSize',9,'FontName','Calibri');
    end
