...
function [Subject]=Revise_features_whole_trial(Subject)
% for Subject=Subjects
    Dataset=3;    
    bands=[1:3]; % 1=broad, 2=delta, 3=theta, 4=alpha, 5=beta, 6=gamma
    Windows=[1];
    ...
    for band=bands   % 1=broad, 2=delta, 3=theta, 4=alpha, 5=beta, 6=gamma
        ...
        for windoww=Windows
            ...
            for feature=[36:37] % features when evaluating time windows
                tic
                if feature==33
