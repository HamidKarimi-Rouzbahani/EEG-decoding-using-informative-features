...
for band=3
    for Subject=5
        ...
        if band==1
            load(['Decoding_Accuracy_ALL_Subject_',num2str(Subject),'_filtered_Delta.mat'],'accuracy');
        elseif band==2
            load(['Decoding_Accuracy_ALL_Subject_',num2str(Subject),'_filtered_Theta.mat'],'accuracy');
        elseif band==3
            load(['Decoding_Accuracy_ALL_Subject_',num2str(Subject),'_filtered_Alpha.mat'],'accuracy');
        elseif band==4
            load(['Decoding_Accuracy_ALL_Subject_',num2str(Subject),'_filtered_Beta.mat'],'accuracy');
        elseif band==5
            load(['Decoding_Accuracy_ALL_Subject_',num2str(Subject),'_filtered_Gamma.mat'],'accuracy');
        end
        for feature=[28:30 32:35]
%         for feature=[1:9 11:20 27:30 32:35]
%         for feature=[30 32:35]
            if feature==33
            ...
            clearvars -except Dataset band Fs True_Predicted_labels accuracy Subject signal feature X Y  net
            ...
            for combination=1:size(combinations,1)
                ...
                [band Subject feature combination]
            end
%             if Dataset==1
%                 DS='DS_Mine';
%             elseif Dataset==2
...
%             end
            ...
            if band==1
                save(['Decoding_Accuracy_ALL_Subject_',num2str(Subject),'_filtered_Delta.mat'],'accuracy');
            elseif band==2
                save(['Decoding_Accuracy_ALL_Subject_',num2str(Subject),'_filtered_Theta.mat'],'accuracy');
            elseif band==3
                save(['Decoding_Accuracy_ALL_Subject_',num2str(Subject),'_filtered_Alpha.mat'],'accuracy');
            elseif band==4
                save(['Decoding_Accuracy_ALL_Subject_',num2str(Subject),'_filtered_Beta.mat'],'accuracy');
            elseif band==5
                save(['Decoding_Accuracy_ALL_Subject_',num2str(Subject),'_filtered_Gamma.mat'],'accuracy');
            end
        end
    end
end
