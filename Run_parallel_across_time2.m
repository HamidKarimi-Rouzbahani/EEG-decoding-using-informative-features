...
%      [subject] = Features_cambridge_across_time_Theta_band_only_flow(allsubs(c)) 
%      [subject] = Features_cambridge_across_time_Theta_band_only_flow2(allsubs(c))   
     [subject] = Revised_features_corrected_new_across_time_bands2(allsubs(c))
end
toc();
