    ...
    for variation=1:4
        for Subject=1:5
            ...
            for feature=[1:9 11:20 27:30 32:35]
                ...
                clearvars -except Bands band variation Fs True_Predicted_labels accuracy Subject signal feature X Y  net
...
%                         True_Predicted_labels{feature,combination,fld,2}=PredictedLabels;
                ...
                if variation==1
                    save(['Decoding_Accuracy_Subject_',num2str(Subject),'Band_',Bands{band},'_Lighting.mat'],'accuracy');
                elseif variation==2
                    save(['Decoding_Accuracy_Subject_',num2str(Subject),'Band_',Bands{band},'_Pose.mat'],'accuracy');
                elseif variation==3
                    save(['Decoding_Accuracy_Subject_',num2str(Subject),'Band_',Bands{band},'_Size.mat'],'accuracy');
                elseif variation==4
                    save(['Decoding_Accuracy_Subject_',num2str(Subject),'Band_',Bands{band},'_Position.mat'],'accuracy');
                end
            end
        end
    end
