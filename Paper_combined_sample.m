    ...
    for Feat_selection=[1:9 12:19]
        for Subject=Subjects
            ...
            for windoww=Windows
                ...
                feat=0;
                for feature=[2:9 11:13 18:30 32 34] % features when evaluating time windows
                    feat=feat+1;
                    if feature==33
                    ...
                    if feature>27
                        ...
                        [coeff,score,~,~,~,mu] =pca(features_reshaped_tmp);
                        features_reshaped_tmp = score*coeff(1:size(signal,1),:)' + repmat(mu(1:size(signal,1)),size(features_reshaped_tmp,1),1);
