        ...
        for Subject=Subjects
            ...
            for windoww=Windows
                ...
                for combination=1:size(combinations,1)
                    ...
                    Classifier_Model = fitcdiscr(Xready,Yready,'DiscrimType','pseudoquadratic');
            ...
            save(['Corrected_Dec_DS_',Datasets{Dataset},'_Band_',Bands{band},'_Wind_sliding_Subject_',num2str(Subject),'_CombFeat_',selection_method,'_PCA_NonLin.mat'],'accuracy','Sel_feat');
        end
    end
end
