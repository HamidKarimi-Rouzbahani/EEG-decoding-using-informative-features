...
%                 features_chosen(:,:,:,feat)=(feature_chosen);
            ...
            %               [fs,history] = sequentialfs(fun,X,y','cv',c,'options');
...
%             Features_selected=numb(1:size(signal,1));                        
%             X=features_chosen_tmp(Features_selected,:)';
        ...
        save(['Corrected_Dec_DS_',Datasets{Dataset},'_Band_',Bands{band},'_Wind_sliding_Subject_',num2str(Subject),'_CombFeat_PCA.mat'],'accuracy','Sel_feat');
    end
end
