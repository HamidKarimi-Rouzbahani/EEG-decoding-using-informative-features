...
%                     XXX = score*coeff(1:size(signal,1),:)' + repmat(mu(1:size(signal,1)),size(XXX,1),1);
            ...
            save(['Corrected_Dec_DS_',Datasets{Dataset},'_Band_',Bands{band},'_Wind_sliding_Subject_',num2str(Subject),'_CombFeat_',selection_method,'_5Feats.mat'],'accuracy','Sel_feat');
        end
    end
end
